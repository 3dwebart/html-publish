<?php
/**
* Description of ViewTradeOrderbookSellDetailBtcEtc Controller
...
* @version 4.0.0
*/
        class ViewTradeOrderbookSellDetailBtcEtc extends ControllerBase{
            ...
            **/
            function __construct(){
                parent::__construct();
                $this->dto = new ViewTradeOrderbookSellDetailBtcEtcDTO();
            }
            
            //DB를 연결할 경우만
            private function initDAO(){
                if(!$this->dao){
                    $this->dao = new ViewTradeOrderbookSellDetailBtcEtcDAO();
            ...
            public function view(){
                ...
                //Input Exception Field ,'odMarketPrice','odTempCoin','odCostSum'
			...
			$this->dto->odCostSum = Utils::getPostParam('odCostSum');
			...
			$this->initModifyPostParam('odCostSum');
                }catch(Exception $e){
                    $json = json_decode($e);
                    $this->returnarr['result'] = (int)$json->code;
                    return $this->returnarr;
            ...
            private function setSearchParam(){
                ...
                if($this->searchField=='od_cost_sum'){
