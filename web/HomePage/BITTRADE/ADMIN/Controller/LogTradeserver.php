...
* @version 4.0.0
*/
        class LogTradeserver extends ControllerBase{
            ...
            **/
            function __construct(){
                parent::__construct();
                $this->dto = new LogTradeserverDTO();
            }
            ...
            private function initDAO(){
                ...
                if(!$this->dao){
                    ...
                    $this->dao = new LogTradeserverDAO();
                    if($this->type) $this->dao->setDbName('fns_trade_order_'.$this->type);
            ...
            public function view(){
                ...
                //Input Exception Field ,'csNo','csCode','csSubject','csContent','csRegDt'
            ...
            public function insert(){
                ...
                try{
			$this->dto->csCode = Utils::getPostParam('csCode');
			$this->dto->csSubject = Utils::getPostParam('csSubject');
			$this->dto->csContent = Utils::getPostParam('csContent');
                    $this->returnarr = $this->returnDTO($this->dto, array('result','csNo','csRegDt'));
                }catch(Exception $e){
                    $json = json_decode($e);
                ...
                //param값 유효성 검사
                $this->returnarr['result'] = parent::checkEmptyValue($this->dto,array('result','csNo','csRegDt'));
			...
			$this->initModifyPostParam('csCode');
            ...
            private function setSearchParam(){
                ...
                if($this->searchField=='cs_no' || $this->searchField=='cs_code' || $this->searchField=='cs_subject' || $this->searchField=='cs_reg_dt'){
