<?php
/**
* Description of MemTradeCompleteKrwBtc Controller
...
* @version 4.0.0
*/
        class MemTradeCompleteKrwBtc extends ControllerBase{
            ...
            **/
            ...
            private function initDAO(){
                if(!$this->dao){
                    ...
                    $this->dao->setDbName('fns_trade_order_btc');
                    $this->dao->setTableName('mem_trade_complete_krw_btc');
