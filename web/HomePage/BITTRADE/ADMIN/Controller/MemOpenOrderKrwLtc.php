<?php
/**
* Description of MemOpenOrderKrwLtc Controller
...
* @version 4.0.0
*/
        class MemOpenOrderKrwLtc extends ControllerBase{
            ...
            **/
            function __construct(){
                parent::__construct();
                $this->dto = new MemOpenOrderDTO();
            }
            
            //DB를 연결할 경우만
            private function initDAO(){
                if(!$this->dao){
                    $this->dao = new MemOpenOrderDAO();
                    $this->dao->setDbName('fns_trade_order_ltc');
                    $this->dao->setTableName('mem_open_order_krw_ltc');
            ...
            public function deleteCompleteData(){
                $this->getViewer()->setResponseType('JSON');
                $this->returnarr = array();
                $this->initDAO();
                
                $this->returnarr['result'] = $this->dao->deleteCompleteData();
            ...
            public function view(){
                ...
                //Input Exception Field ,'odId','odAction','odPayStatus','odMarketPrice','odTotalCost','mbNo','mbId','odFeeRate','odTempCoin','odReceiptCoin','odReceiptFee','odReceiptAvg','odReceiptDt','odRegDt','tmpTrigerAc'
            ...
            public function insert(){
                ...
                try{
			$this->dto->odId = Utils::getPostParam('odId');  //int type
			...
			$this->dto->tmpTrigerAc = Utils::getPostParam('tmpTrigerAc');
                    $this->returnarr = $this->returnDTO($this->dto, array('result','odId','odMarketPrice','odTotalCost','odFeeRate','odTempCoin','odReceiptCoin','odReceiptFee','odReceiptAvg','odRegDt'));
                }catch(Exception $e){
                    $json = json_decode($e);
                ...
                //param값 유효성 검사
                $this->returnarr['result'] = parent::checkEmptyValue($this->dto,array('result','odId','odMarketPrice','odTotalCost','odFeeRate','odTempCoin','odReceiptCoin','odReceiptFee','odReceiptAvg','odRegDt'));
            ...
            private function setSearchParam(){
                ...
                if($this->searchField=='od_id'  || $this->searchField=='mb_no' || $this->searchField=='od_market_price' || $this->searchField=='od_total_cost' || $this->searchField=='mb_id' || $this->searchField=='od_fee_rate' || $this->searchField=='od_temp_coin' || $this->searchField=='od_receipt_coin' || $this->searchField=='od_receipt_fee' || $this->searchField=='od_receipt_avg' || $this->searchField=='od_reg_dt' || $this->searchField=='tmp_triger_ac'){
