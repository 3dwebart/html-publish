...
* @version 4.0.0
*/
        class TradeDashboardKrwBch extends ControllerBase{
            ...
            private $dbName = 'fns_trade_order_bch';
            private $dbTableName = 'mem_open_order_krw_bch';
            /**
            * @brief
            **/
            function __construct(){
                parent::__construct();
                $this->dao = new TradeDashboardKrwBchDAO();
                $this->dto = new TradeDashboardKrwBchDTO();
            }
            ...
            public function marketList(){
                ...
                $objdao = new TradeDashboardKrwBchDAO();
                $objdao->setDbName('fns_trade_order_bch');
