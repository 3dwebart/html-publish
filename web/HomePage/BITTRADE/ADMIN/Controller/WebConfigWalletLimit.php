<?php
/**
* Description of WebConfigWalletLimit Controller
...
* @version 4.0.0
*/
        class WebConfigWalletLimit extends ControllerBase{
            ...
            **/
            function __construct(){
                parent::__construct();
                $this->dto = new WebConfigWalletLimitDTO();
            }

            //DB를 연결할 경우만
            private function initDAO(){
                if(!$this->dao){
                    $this->dao = new WebConfigWalletLimitDAO();
            ...
            public function view(){
                ...
                //Input Exception Field ,'cfNo','cfCountryCode','cfWalletType','cfMbLevel','cfMaxDeposit','cfMaxWithdraw','cfMaxDay','cfRegDt'
            ...
            public function insert(){
                ...
                try{
                    ...
                    $this->dto->cfWalletType = Utils::getPostParam('cfWalletType');
                    $this->dto->cfMbLevel = (int)Utils::getPostParam('cfMbLevel');
                    $this->dto->cfMaxDeposit = Utils::getPostParam('cfMaxDeposit');
                    $this->dto->cfMinWithdraw = Utils::getPostParam('cfMinWithdraw',ResError::no);
                    $this->dto->cfMaxWithdraw = Utils::getPostParam('cfMaxWithdraw');
                    $this->dto->cfMaxDay = Utils::getPostParam('cfMaxDay',ResError::no);
                    $this->returnarr = $this->returnDTO($this->dto, array('result','cfNo','cfMaxDay','cfRegDt'));
                }catch(Exception $e){
                    $json = json_decode($e);
                ...
                //param값 유효성 검사
                $this->returnarr['result'] = parent::checkEmptyValue($this->dto,array('result','cfNo','cfMaxDay','cfRegDt'));
            ...
            public function update(){
                ...
                try{
                    ...
                    $this->initModifyPostParam('cfWalletType');
                    $this->initModifyPostParam('cfMbLevel');  //int type
                    $this->initModifyPostParam('cfMaxDeposit');
                    $this->initModifyPostParam('cfMaxWithdraw');
                    $this->initModifyPostParam('cfMinWithdraw',ResError::no);
                    $this->initModifyPostParam('cfMaxDay',ResError::no);
                }catch(Exception $e){
                    $json = json_decode($e);
                    $this->returnarr['result'] = (int)$json->code;
                    return $this->returnarr;
            ...
            private function setSearchParam(){
                ...
                if($this->searchField=='cf_no' || $this->searchField=='cf_country_code' || $this->searchField=='cf_wallet_type' || $this->searchField=='cf_mb_level'){
