...
* @version 4.0.0
*/
        class TradeDashboardKrwBtc extends ControllerBase{
            ...
            private $dbName = 'fns_trade_order_btc';
            private $dbTableName = 'mem_open_order_krw_btc';
            /**
            * @brief
            **/
            function __construct(){
                parent::__construct();
                $this->dao = new TradeDashboardKrwBtcDAO();
                $this->dto = new TradeDashboardKrwBtcDTO();
            }
...
//                $objdao = new TradeDashboardKrwBtcDAO();
...
//            }
            ...
            public function untradeorderjoin(){
                ...
                $objdao->setListOrderBy(array('od_id'=>'ASC'));
                $objdao->setListLimitRow(1000);
                $list = $objdao->getUnTradeList('od_market_price',(isset($cost)?$cost:0));
