...
* @version 4.0.0
*/
        class WithdrawalsSendETC extends ControllerBase{
            ...
            public function checkReceiptTxid(){
                ...
                $result = $this->walletRPC->call()->eth_getTransactionReceipt($txid);
                return $result;
            }
            ...
            public function updateSendMany(){
                ...
                for($i=0; $i< count($tmparr);$i++){
                    ...
                    //{from:address,to:address1,value:web3.toWei(0.192, "ether")};
                    /*
                     * {
