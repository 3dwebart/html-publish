...
* @version 4.0.0
*/
        class WebPointKrwDAO extends BaseDAO{
                ...
                if($this->dbSlave){
                    try{
                        $sql = "SELECT 	po_no,
                                    ...
                                    po_reg_dt,
                                    po_reg_ip
                                FROM web_point_krw WHERE po_no=?  limit 1";
                ...
                if($this->dbSlave){
                    try{
                        ...
                        $sql = "SELECT 	po_no,
                                    ...
                                    po_reg_dt,
                                    po_reg_ip
                                FROM web_point_krw{$sql_add} LIMIT ?,?";
                ...
                if($this->dbSlave){
                    try{
                        $sql = "SELECT 	po_no,
                                    ...
                                    po_reg_dt,
                                    po_reg_ip
                                FROM web_point_krw WHERE mb_no=? and po_rel_action=? and po_rel_id=? limit 1";

                        if($this->dbSlave) $stmt = $this->dbSlave->prepare($sql);
                        if($stmt){
                            $k=1;
                            $stmt->bindValue( $k++, $mb_no, PDO::PARAM_INT);
            ...
            public function getListCount($field='',$value='',$svdf='',$svdt=''){
                ...
                if($this->dbSlave){
                    try{
                        ...
                        $sql = "SELECT count(*)  FROM web_point_krw{$sql_add}";
            ...
            function deleteFromPri($pri){
                ...
                if($this->db){
                    ...
                    $sql = "DELETE FROM web_point_krw WHERE po_no=?";
