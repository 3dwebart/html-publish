<?php
/**
* Description of ViewTradeBitcoinBuy Controller
...
* @version 4.0.0
*/
        class ViewTradeBitcoinBuy extends ControllerBase{
            ...
            **/
            function __construct(){
                parent::__construct();
                $this->dto = new ViewTradeBitcoinBuyDTO();
            }
            
            //DB를 연결할 경우만
            private function initDAO(){
                if(!$this->dao){
                    $this->dao = new ViewTradeBitcoinBuyDAO();
