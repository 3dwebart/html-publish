...
//        try {
//                $this->rpcserver = new jsonRPCClient('http://'.$this->cfg['bitcoin']['serverId'].':'.$this->cfg['bitcoin']['serverPwd'].'@'.$this->cfg['bitcoin']['server'].'/',true);
//        }
//        catch (Exception $e) {
...
//    }
    ...
    public function move($fromaccount,$toaccount,$amount){
        ...
        return $this->rpcserver->move($fromaccount,$toaccount,floatval($amount));
    }
     ...
     */
    public function getDistinctCreateAddress($mb_id){
    ...
    public function getRPCAccountByAddress($address){
        return $this->rpcserver->getaccount($address);
    }
