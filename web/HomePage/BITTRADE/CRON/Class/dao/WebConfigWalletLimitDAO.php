...
*/
        class WebConfigWalletLimitDAO extends BaseDAO{
            ...
            public function getListCount($field='',$value='',$svdf='',$svdt=''){
                ...
                if($this->dbSlave){
                    try{
                        $singleFields = array('cf_no','cf_wallet_type','cf_mb_level','cf_max_day');
                ...
                if($this->db){
                    try{
                        ...
                        if($stmt){
                            ...
                            $stmt->bindValue( $j++, $dto->cfWalletType, PDO::PARAM_STR);
                            $stmt->bindValue( $j++, $dto->cfMbLevel, PDO::PARAM_INT);
                            $stmt->bindValue( $j++, $dto->cfMaxDeposit, PDO::PARAM_STR);
                            $stmt->bindValue( $j++, $dto->cfMaxWithdraw, PDO::PARAM_STR);
