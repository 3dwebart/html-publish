<?php
/**
* Description of ViewTradeOrderbookCompleteDetailBtcEtc Controller
...
* @version 4.0.0
*/
        class ViewTradeOrderbookCompleteDetailBtcEtc extends ControllerBase{
            ...
            **/
            function __construct(){
                parent::__construct();
                $this->dto = new ViewTradeOrderbookCompleteDetailBtcEtcDTO();
            }
            
            //DB를 연결할 경우만
            private function initDAO(){
                if(!$this->dao){
                    $this->dao = new ViewTradeOrderbookCompleteDetailBtcEtcDAO();
            ...
            public function view(){
                ...
                //Input Exception Field ,'trNo','odAction','trMarketCost','trTotalCoin','trRegDt','odId','trTotalCost'
            ...
            public function insert(){
                ...
                try{
			$this->dto->trNo = Utils::getPostParam('trNo',ResError::no);
			...
			$this->dto->trRegDt = Utils::getPostParam('trRegDt');
			$this->dto->odId = (int)Utils::getPostParam('odId');
			$this->dto->trTotalCost = Utils::getPostParam('trTotalCost',ResError::no);
                    $this->returnarr = $this->returnDTO($this->dto, array('result','','trNo','trMarketCost','trTotalCoin','trTotalCost'));
                }catch(Exception $e){
                    $json = json_decode($e);
                ...
                //param값 유효성 검사
                $this->returnarr['result'] = parent::checkEmptyValue($this->dto,array('result','','trNo','trMarketCost','trTotalCoin','trTotalCost'));
            ...
            public function update(){
                ...
                try{
			$this->initModifyPostParam('trNo',ResError::no);
			...
			$this->initModifyPostParam('trRegDt');
			$this->initModifyPostParam('odId');  //int type
			$this->initModifyPostParam('trTotalCost',ResError::no);
                }catch(Exception $e){
                    $json = json_decode($e);
                    $this->returnarr['result'] = (int)$json->code;
                    return $this->returnarr;
            ...
            private function setSearchParam(){
                ...
                if($this->searchField=='od_action' || $this->searchField=='tr_market_cost' || $this->searchField=='tr_total_coin' || $this->searchField=='tr_reg_dt' || $this->searchField=='tr_total_cost'){
