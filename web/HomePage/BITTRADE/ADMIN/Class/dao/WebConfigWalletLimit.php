...
*/
        class WebConfigWalletLimit extends ControllerBase{
            ...
            **/
			...
			$this->dto->cfMaxDeposit = (int)Utils::getPostParam('cfMaxDeposit');
			$this->dto->cfMaxWithdraw = (int)Utils::getPostParam('cfMaxWithdraw');
			...
			$this->initModifyPostParam('cfMaxDeposit');  //int type
			$this->initModifyPostParam('cfMaxWithdraw');  //int type
            ...
            private function setSearchParam(){
                ...
                if($this->searchField=='cf_no' || $this->searchField=='cf_wallet_type' || $this->searchField=='cf_max_day' || $this->searchField=='cf_reg_dt'){
