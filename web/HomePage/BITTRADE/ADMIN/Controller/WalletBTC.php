...
* @version 4.0.0
*/
class WalletBTC extends ControllerBase{
    ...
    function __construct(){
        ...
        $dto = $wsvDAO->getViewByPoType('btc');
    ...
    public function getbalance() {
        $this->getViewer()->setResponseType('JSON');
        $param = Utils::getUrlParam('param',  ResError::no);
        return $this->bitcoinRPC->rpc('getbalance',"*") ;
    }
    ...
    public function bitmove() {
        ...
        if($account!=$this->config['bitcoin']['system_account'] ){
            return array('result'=>false,'error'=>'unknow user');
        }
