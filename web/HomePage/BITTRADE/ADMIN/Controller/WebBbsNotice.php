...
* @version 0.2.2
*/
        class WebBbsNotice extends ControllerBase{
            ...
            **/
            function __construct(){
                ...
                $this->dao->setCateChno($this->chNo);
...
//                }
            ...
            public function update(){
                ...
                try{
                    $this->initModifyPostParam('chNo');  //int type
                    $this->dto->cateName = $this->getBbsName($this->dto->chNo);
                    $this->initModifyPostParam('isHtml',ResError::no);  //int type
                    $this->initModifyPostParam('subject');
                    $this->initModifyPostParam('subjectKr',ResError::no);
                    $this->initModifyPostParam('subjectCn',ResError::no);
                    $this->initModifyPostParam('viewLevel',ResError::no);
                    $this->initModifyPostParam('viewPoint',ResError::no);  //int type
                    $this->initModifyPostParam('viewPwd',ResError::no);
                    $this->initModifyPostParam('imageUrl',ResError::no);
                    $this->initModifyPostParam('cmtUseYn',ResError::no);
                    $this->initModifyPostParam('cmtLevel',ResError::no);
                    $this->initModifyPostParam('hit',ResError::no);  //int type
                    $this->initModifyPostParam('cmtCnt',ResError::no);
                    $this->initModifyPostParam('etc1',ResError::no);
                    $this->initModifyPostParam('etc2',ResError::no);
                    $this->initModifyPostParam('etc3',ResError::no);
                    $this->initModifyPostParam('etc4',ResError::no);
                    $this->initModifyPostParam('etc5',ResError::no);
