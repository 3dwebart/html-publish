        ...
        class WebConfigWalletServer extends ControllerBase{
            ...
            **/
            ...
            public function view(){
                ...
                //Input Exception Field ,'waNo','coId','waExplain','waStaus','waRpcIp','waRpcPort','waRegDt'
			...
			$this->dto->waRpcPort = Utils::getPostParam('waRpcPort');
                    $this->returnarr = $this->returnDTO($this->dto, array('result','waNo','waRegDt'));
                }catch(Exception $e){
                    $json = json_decode($e);
                ...
                //param값 유효성 검사
                $this->returnarr['result'] = parent::checkEmptyValue($this->dto,array('result','waNo','waRegDt'));
			...
			$this->initModifyPostParam('waExplain');
			$this->initModifyPostParam('waStaus');
			$this->initModifyPostParam('waRpcIp');
			$this->initModifyPostParam('waRpcPort');
                }catch(Exception $e){
                    $json = json_decode($e);
                    $this->returnarr['result'] = (int)$json->code;
                    return $this->returnarr;
            ...
            private function setSearchParam(){
                ...
                if($this->searchField=='wa_no' || $this->searchField=='wa_explain' || $this->searchField=='wa_rpc_ip' || $this->searchField=='wa_rpc_port' || $this->searchField=='wa_reg_dt'){
