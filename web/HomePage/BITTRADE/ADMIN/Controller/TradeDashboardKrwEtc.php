...
* @version 4.0.0
*/
        class TradeDashboardKrwEtc extends ControllerBase{
            ...
            **/
            function __construct(){
                parent::__construct();
                $this->dao = new TradeDashboardKrwEtcDAO();
                $this->dto = new TradeDashboardKrwEtcDTO();
            }
            ...
            public function main(){
                ...
                $this->dao->setDbName('fns_trade_order_etc');
            ...
            public function marketList(){
                ...
                $objdao = new TradeDashboardKrwEtcDAO();
                $objdao->setDbName('fns_trade_order_etc');
