        ...
        class WebConfigTradeFee extends ControllerBase{
            ...
            **/
            ...
            public function view(){
                ...
                //Input Exception Field ,'cfNo','cfMarketType','cfTrTrackerFee','cfTrMarketmakerFee','cfOrderMinBtc','cfOrderMinCoin','cfCallUnitBtc','cfCallUnitCoin','cfRegDt'
                $this->returnarr = $this->returnDTO($this->dto, array());

                if($this->dto->cfNo){
                    if($this->dto->cfNo!=$pri){
                        $resultArray['result'] = ResError::paramUnMatchPri;
                        $resultArray['resultMsg'] = String::paramUnMatchPri;
                    }
                }else{
                    $resultArray['result'] = 0;
                    $resultArray['resultMsg'] = String::dataNotResult;
                }
            ...
            public function insert(){
                ...
                try{
			$this->dto->cfMarketType = Utils::getPostParam('cfMarketType',ResError::no);
			$this->dto->cfTrTrackerFee = Utils::getPostParam('cfTrTrackerFee',ResError::no);
			$this->dto->cfTrMarketmakerFee = Utils::getPostParam('cfTrMarketmakerFee',ResError::no);
			$this->dto->cfOrderMinBtc = Utils::getPostParam('cfOrderMinBtc',ResError::no);
			$this->dto->cfOrderMinCoin = Utils::getPostParam('cfOrderMinCoin',ResError::no);
			$this->dto->cfCallUnitBtc = Utils::getPostParam('cfCallUnitBtc',ResError::no);
			$this->dto->cfCallUnitCoin = Utils::getPostParam('cfCallUnitCoin',ResError::no);
                    $this->returnarr = $this->returnDTO($this->dto, array('result','cfNo','cfMarketType','cfTrTrackerFee','cfTrMarketmakerFee','cfOrderMinBtc','cfOrderMinCoin','cfCallUnitBtc','cfCallUnitCoin','cfRegDt'));
                }catch(Exception $e){
                    $json = json_decode($e);
                ...
                //param값 유효성 검사
                $this->returnarr['result'] = parent::checkEmptyValue($this->dto,array('result','cfNo','cfMarketType','cfTrTrackerFee','cfTrMarketmakerFee','cfOrderMinBtc','cfOrderMinCoin','cfCallUnitBtc','cfCallUnitCoin','cfRegDt'));
			...
			$this->initModifyPostParam('cfOrderMinBtc',ResError::no);
			$this->initModifyPostParam('cfOrderMinCoin',ResError::no);
			$this->initModifyPostParam('cfCallUnitBtc',ResError::no);
            ...
            private function setSearchParam(){
                ...
                if($this->searchField=='cf_no' || $this->searchField=='cf_market_type' || $this->searchField=='cf_tr_tracker_fee' || $this->searchField=='cf_tr_marketmaker_fee' || $this->searchField=='cf_order_min_btc' || $this->searchField=='cf_order_min_coin' || $this->searchField=='cf_call_unit_btc' || $this->searchField=='cf_call_unit_coin' || $this->searchField=='cf_reg_dt'){
