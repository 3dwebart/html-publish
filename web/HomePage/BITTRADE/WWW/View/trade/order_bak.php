...
<body>
        ...
        <div class="coin-status" id="coinStatus">
            ...
            <div class="status <?=$view['exchannel']['sock_ch']?>">
                <dl>
                    ...
                    <dd class="red def_24hr_high ">0</dd>
                </dl>
                <dl>
                    <dt><?=Language::langConvert($view['langcommon'], 'low');?></dt>
                    <dd class="blue def_24hr_low">0</dd>
                </dl>
                <p class="blue"><strong>999999</strong><span class="def_per_change">8.32%</span></p>
            </div>
	<a href="#" class="btn-m-coins"></a>
        ...
        <div class="new-trade"  id="dash-currency-main">
            <div class="graph-box">
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><?php Language::langConvert($view['lang'], 'openOrdersBtc');?></th>
                    ...
                    <table>
                        <tbody class="<?=$view['exchannel']['sock_ch']?>">
                            ...
                            <tr>
                                ...
                                <td><span class="def_per_change">0</span></td>
                            </tr>
                            <tr>
                                <th><?php Language::langConvert($view['langcommon'], 'high');?></th>
                                <td><span class="red def_24hr_high">0</span> </td>
                            </tr>
                            <tr>
                                <th><?php Language::langConvert($view['langcommon'], 'low');?></th>
                                <td><span class="blue def_24hr_low">0</span> </td>
                            </tr>
                            <tr>
                    ...
                    <div>
                        <div class="mine">
                            <div class="available">
                                ...
                                <strong><span class="bal_poss_krw">0</span>KRW</strong>
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="mine">
                            <div class="available">
                                ...
                                <strong><span class="bal_poss_<?=strtolower($view['exchannel']['currency_type'])?>">0.00000000</span> <?=$view['exchannel']['currency_type']?></strong>
                            </div>
                        </div>
                        <div class="form-section">
                            <dl>
...
<!--    <script src="<?=$view['url']['static']?>/assets/script/controller-chartview.min.js?v=<?=Language::langConvert($view['langcommon'], 'version');?>"></script>-->
    <script src="<?=$view['url']['static']?>/assets/script/controller-market.min.js?v=<?=Language::langConvert($view['langcommon'], 'version');?>"></script>
    <script src="<?=$view['url']['static']?>/assets/script/controller-trade.min.js?v=<?=Language::langConvert($view['langcommon'], 'version');?>"></script>
    <script>
