<?php      
/**
* Description of MemTradeCompleteDAO
...
* @version 4.0.0
*/
        class MemTradeCompleteDAO extends BaseDAO{

            private $db;
            private $dbSlave;
            private $dbName = 'fns_trade_order_etc';
            private $dbTableName = 'mem_trade_complete_btc_etc';
            ...
            public function getList($field='',$value='',$svdf='',$svdt=''){
				...
				$dto->odId,
				$dto->fromMbNo) = $stmt->fetch()) {
                                    $dtoarray[$i] = new MemTradeCompleteDTO();
