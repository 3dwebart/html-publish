<?php
/**
* Description of ViewTradeOrderbookBuyDetailBtcEtc Controller
...
* @version 4.0.0
*/
        class ViewTradeOrderbookBuyDetailBtcEtc extends ControllerBase{
            ...
            **/
            function __construct(){
                parent::__construct();
                $this->dto = new ViewTradeOrderbookBuyDetailBtcEtcDTO();
            }
            
            //DB를 연결할 경우만
            private function initDAO(){
                if(!$this->dao){
                    $this->dao = new ViewTradeOrderbookBuyDetailBtcEtcDAO();
