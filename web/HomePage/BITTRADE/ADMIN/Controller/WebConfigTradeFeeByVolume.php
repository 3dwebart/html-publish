<?php
/**
* Description of WebConfigTradeFeeByVolume Controller
...
* @version 4.0.0
*/
        class WebConfigTradeFeeByVolume extends ControllerBase{
            ...
            **/
            function __construct(){
                parent::__construct();
                $this->dto = new WebConfigTradeFeeByVolumeDTO();
            }
            
            //DB를 연결할 경우만
            private function initDAO(){
                if(!$this->dao){
                    $this->dao = new WebConfigTradeFeeByVolumeDAO();
            ...
            public function view(){
                ...
                //Input Exception Field ,'cfNo','cfMarketType','cfMaxVolume','cfTrTrackerFee','cfTrMarketmakerFee','cfMaxDay','cfRegDt'
			...
			$this->dto->cfMaxVolume = (int)Utils::getPostParam('cfMaxVolume');
			...
			$this->initModifyPostParam('cfMarketType');
			$this->initModifyPostParam('cfMaxVolume');  //int type
			$this->initModifyPostParam('cfTrTrackerFee');
			$this->initModifyPostParam('cfTrMarketmakerFee');
            ...
            private function setSearchParam(){
                ...
                if($this->searchField=='cf_no' || $this->searchField=='cf_market_type' || $this->searchField=='cf_max_day' || $this->searchField=='cf_reg_dt'){
