...
(function($) {
    $.fn.jPaginator = function(o) {
        ...
        return this.each(function() {
            ...
            // events
            $(this).bind('selectpage', function(event,o) {
                
                
                $.extend(s, o);
//                $(".paginator_p_bloc .paginator_p").removeClass("selected");
//
//                $($this.find(".paginator_p_bloc .paginator_p").get( o.selectedPage-1 )).addClass("selected");
                goToSelectedPage();
