...
* @version 4.0.0
*/
        class TradeDashboardKrwLtc extends ControllerBase{
            ...
            private $dbName = 'fns_trade_order_ltc';
            private $dbTableName = 'mem_open_order_krw_ltc';
            /**
            * @brief
            **/
            function __construct(){
                parent::__construct();
                $this->dao = new TradeDashboardKrwLtcDAO();
                $this->dto = new TradeDashboardKrwLtcDTO();
            }
            ...
            public function marketList(){
                ...
                $objdao = new TradeDashboardKrwLtcDAO();
                $objdao->setDbName('fns_trade_order_ltc');
            ...
            //미체결된 주문리스트
//            public function tradeorderbycost(){
//                $this->getViewer()->setResponseType('JSON');
