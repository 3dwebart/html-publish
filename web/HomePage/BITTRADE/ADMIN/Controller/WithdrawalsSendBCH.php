...
* @version 4.0.0
*/
        class WithdrawalsSendBCH extends ControllerBase{
            ...
            **/
            ...
            public function updateSendMany(){
                ...
                //발란스 체크
                $bchtotal = $this->bitcoinRPC->getRPCBalance($this->sendaccount);
                if(!$bchtotal || $bchtotal < $tmpcoinsum){
                    return array('result'=>-5999,'msg'=>'코인서버 잔액이 부족합니다. 출금 시도 금액 : ' .$tmpcoinsum . ' 서버잔액(계정:'.$this->sendaccount.') : ' . $bchtotal);
                }
