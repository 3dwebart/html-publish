function BitcoinAddressCheck(address){
    var v=bitcoincheck(address);
    if(v==false){
        return false;
    }else{
        return true;
...
function bitcoincheck(address) {
    var decoded = base58decode2(address);   
